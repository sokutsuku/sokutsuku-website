...
export const pricingFaqItems: AccordionItemData[] = [
  ...
  },
  {
    id: 'pricing-faq-3',
    title: '追加費用は発生しますか？',
    content: 'オプションプランを選択しない限り追加費用は発生しません。\nただし、WEBサイトを維持するために本サービス以外で発生する費用がございます。'
  },
  {
    id: 'pricing-faq-4',
    title: '月額費用は必要ですか？',
    content: '本サービスでの月額費用はありませんが、WEBサイトを維持するために発生する費用がございます。\nドメインの維持費はサイトの規模に関わらず必要します。\nノーコードやワードプレス、サーバーなどの利用料はウェブサイトの実装方法によっては必要します。'
  },
  {
    id: 'pricing-faq-5',
    title: '分割払いや月額プランはありますか？',
    content: 'ご契約時に40%をお支払い頂き、ウェブサイトの公開時に残りの60%をお支払い頂きます。\n月額プランは現在対応しておりません。'
  },
  {
    id: 'pricing-faq-6',
    title: 'ドメイン・サーバーの費用は含まれていますか？',
    content: 'ドメイン取得費用は含まれています。\nただし、ドメイン名の用意や取得後の維持費は御社でご負担頂く必要がございます。'
  },
];
...
export const deliveryFaqItems: AccordionItemData[] = [
  ...
  // 例:
  {
    ...
    content: 'ライトプラン：ヒアリング実施後、最短2週間で納品可能です。（テキスト・画像のご用意が完了している場合）\nスタンダードプラン：ヒアリング実施後、最短2週間で納品可能です。（テキスト・画像のご用意が完了している場合）\nプレミアムプラン：ヒアリング実施後、最短1ヶ月で納品可能です。（テキスト・画像のご用意が完了している場合'
  },
  {
    id: 'delivery-faq-2',
    title: '納期はどのように決まりますか？',
    content: '制作するサイトのページ数によって変動いたします。\nまた、クライアントさまからご提供頂く「画像・テキスト」の有無によっても変動いたします。'
  },
  {
    id: 'delivery-faq-3',
...
export const revisionSupportFaqTitle = "修正・サポートについて";