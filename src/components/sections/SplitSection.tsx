  ...
  return (
    <section className={cn('w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-8 xl:px-0 py-16 md:py-24', className)}>
      ...
      <div className={cn(
        ...
        <div className={cn('flex flex-col justify-center relative z-10 order-2 md:order-none', { 'md:order-last': reverse })}>
          {textContent}
        </div>
        <div className={cn('flex items-center justify-center relative z-0 order-1 md:order-none', { 'md:order-first': reverse })}>
          {visualContent}
        </div>
      </div>
    </section>
